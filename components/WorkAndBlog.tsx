...
const cases = [
  {
    ...
    desc: "Open-source scaffolding template for Soroban smart contracts — cut project setup from days to minutes. The go-to starting point for Stellar developers worldwide.",
    year: "2024",
